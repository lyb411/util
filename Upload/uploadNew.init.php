...
// +----------------------------------------------------------------------
include_once dirname(__FILE__).'/upload/Local.php';
...
class uploadNewInit {
    ...
    private function setDriver($driver = null, $config = null){
        ...
        $driver = 'Local';
        $config = null;//$config ? : ($this->driverConfig ? : C('UPLOAD_TYPE_CONFIG'));
        $class = 'Local';//strpos($driver,'\\')? $driver : 'Think\\Upload\\Driver\\'.ucfirst(strtolower($driver));
