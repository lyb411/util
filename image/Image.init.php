...
//导入类库
include_once dirname(__FILE__).'/img/Image/Gd.class.php';
include_once dirname(__FILE__).'/img/Image/GIF.class.php';
include_once dirname(__FILE__).'/img/Image/Imagick.class.php';
